#!C:\Users\Светлана\Desktop\learning\МДК\МДК 02.02 Инструментальные средства разработки ПО, У.С. Опалева\Programs\LR2_01_BottleWebProject_Demidova\LR2_01_BottleWebProject_Demidova\env\Scripts\python.exe
# -*- coding: utf-8 -*-
"""
